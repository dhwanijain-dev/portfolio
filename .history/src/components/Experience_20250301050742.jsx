...
function Particles() {
  ...
  return (
    <Points ref={ref} positions={positions} stride={3}>
      <PointMaterial import { Center, ContactShadows, Environment, Float, MeshDistortMaterial, MeshReflectorMaterial, PointMaterial, Points, RoundedBox, Stars, useScroll} from "@react-three/drei";
      import {Avatar} from "./Avatar";
      import SectionTitle from "./SectionTitle";
      import {useEffect, useRef, useState} from "react";
      import {useFrame} from "@react-three/fiber";
  ...
  const [positions] = useState(() => {
    const arr = new Float32Array(500 * 3);
      ...
      return (
      <Points ref={ref} positions={positions} stride={3}>
        <PointMaterial vertexColors size={0.1} transparent />
      </Points>
      );
}
export const Experience = () => {
 ...
 vertexColors size={0.1} transparent />
    </Points>
  );
}
export const Experience = () => {
