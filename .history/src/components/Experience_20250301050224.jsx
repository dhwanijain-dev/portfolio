import { Center, ContactShadows, Environment, Float, MeshDistortMaterial, MeshReflectorMaterial, RoundedBox, Stars, useScroll } from "@react-three/drei";
    ...
    <>
      ...
      <mesh position-y={-0.005} rotation-x={-Math.PI / 2}>
        ...
        <motion.group ref={sceneContainer} animate={section} >
          ...
          <Stars radius={50} depth={50} count={5000} factor={4} saturation={0} />
