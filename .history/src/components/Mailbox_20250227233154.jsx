...
export function Mailbox(props) {
  ...
  const [mailboxHovered, setMailboxHovered] = useState(flas)

  useEffect(()=>{

    const emmisiveColor = new THREE.Color("ffc527")
  ...
  useFrame(()=>{
    Object.values(materials).forEach((material) => {
      material.emmisiveIntensity = THREE.MathUtils.lerp(material.emmisiveIntensity,mailboxHovered ? 0.32: 0,0.1)  
    })
